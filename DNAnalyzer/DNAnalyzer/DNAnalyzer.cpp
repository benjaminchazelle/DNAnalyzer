...
// DNAnalyzer.cpp : Définit les comportements de classe pour l'application.
//
...
BEGIN_MESSAGE_MAP(CDNAnalyzerApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// construction CDNAnalyzerApp

CDNAnalyzerApp::CDNAnalyzerApp()
{
...
// Seul et unique objet CDNAnalyzerApp

CDNAnalyzerApp theApp;


// initialisation de CDNAnalyzerApp

BOOL CDNAnalyzerApp::InitInstance()
{
