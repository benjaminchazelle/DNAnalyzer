...
// DNAnalyzerClient.cpp : Définit les comportements de classe pour l'application.
//
...
BEGIN_MESSAGE_MAP(CDNAnalyzerClientApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// construction CDNAnalyzerClientApp

CDNAnalyzerClientApp::CDNAnalyzerClientApp()
{
...
// Seul et unique objet CDNAnalyzerClientApp

CDNAnalyzerClientApp theApp;


// initialisation de CDNAnalyzerClientApp

BOOL CDNAnalyzerClientApp::InitInstance()
{
